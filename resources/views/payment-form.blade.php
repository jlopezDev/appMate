...
@section('content')
    <div class="container">
        <div class="row">
                ...
                <div class="payment-container">
                    <div>
                        <div class="content mb-30">
                            <h3 class="title">En MATE agradecemos su compromiso con el arte y la cultura:</h3>
                            <small>Gracias a su donación y apoyo, es que podemos seguir presentando exhibiciones de vanguardia y desarrollando nuestro programa educativo que tiene como principal objetivo promover las industrias creativas en niños y jóvenes de nuestro país. Desarrollando e impulsando así, la cultura visual en nuestros visitantes.</small>
                        </div>
                        <div class="line-down"></div>
                        <form id="payment-form">
                            <input type="hidden" name="lang" id="lang" value="es" />
                            <ul class="steps-name">
                                <li class="step-1 active">Cantidad</li>
                                <li class="step-2">Nombre</li>
                            ...
                            <fieldset id="step-1">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 container-quantity">
                                        <input type="number" class="form-control custom-quantity" name="other_amount" id="other_amount" placeholder="Otro monto...">
                                    </div>
                                </div>
                                <div class="row" id="first-next-button" style="display: none;">
                                    <div class="col-md-12 container-input">
                                        <p class="error-form">Ingresa o selecciona un monto a donar.</p>
                                        <button type="button" class="btn btn-block next action-button">Siguiente</button>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset id="step-2">
                                ...
                                <div class="row">
                                    <div class="col-md-12 container-input">
                                        <div class="form-group">
                                            <label for="province">* Provincia / Estado / Región</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 container-input">
                                        <p class="error-form">Por favor corrija los errores que se muestran arriba.</p>
                                        <input type="button" name="next" class="btn btn-block next action-button" value="Siguiente"/>
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset id="step-3">
                                <div class="row">
                                    <div class="col-md-12 container-input">
                                        <div class="form-group">
                                            <label for="number" style="display: block;">* Número de Tarjeta <img src="assets/img/donar-mate.png" style="float: right;"></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 container-input">
                                        <label>
                                            <input type="checkbox" id="chk-recurrent" name="recurrent" /> Deseo que mi donación sea recurrente.
                                        </label>
                                    </div>
                                </div>
                                <div class="row" id="recurrent-payments" style="display: none;">
                                    <div class="col-md-6 container-quantity">
                                        <button class="btn btn-block btn-recurrent-mode" data-mode="mensual" type="button">Mensual</button>
                                    </div>
                                    <div class="col-md-6 container-quantity">
                                        <button class="btn btn-block btn-recurrent-mode" data-mode="anual" type="button">Anual</button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 container-input">
                                        <button type="submit" class="btn btn-block submit action-button">Aceptar</button>
                                    </div>
                                </div>
            ...
            <div class="col-md-5 pull-right" style="margin-right: 5%;">
                <h2 class="message-page">
                    El arte te da poder para comunicar,<br>
                    ojos para valorar, mente para crear<br>
                    y alas para volar.<br>
                </h2>
