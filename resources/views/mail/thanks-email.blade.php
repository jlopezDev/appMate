                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="middle" class="textContent">
                                                                ...
                                                                <p style="text-align: left; font-size: 16px; color: #000000; line-height: 30px;">Hola,<br>He donado a MATE, ayudando así a desarrollar la creatividad y el talento de los niños. Tú también puedes donar y promover la educación y el arte.</p><br>

                                                                <p style="text-align: center;"><a style="background: #000; color: #FFF; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; padding-right: 20px;" href="https://www.mate.pe/demo-donacion" target="_blank">DONA</a></p><br>
                                                                <p style="text-align: center; color: #000;">Conoce más de MATE <a style="color: #000;" href="https://www.mate.pe" target="_blank">aquí</a>.</p>
                                                                <br>
                                                                <p style="text-align: left; color: #000000;">Saludos<br><br>{{$name}}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
