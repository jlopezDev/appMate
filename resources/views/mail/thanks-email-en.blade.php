                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent" style="padding-top: 30px; padding-bottom: 0;">
                                                                ...
                                                                <img src="https://mate.pe/demo-donacion/assets/img/banner-thanks.png" style="width: 100%;" border="0" />
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="middle" class="textContent">
                                                                ...
                                                                <p style="text-align: left; font-size: 16px; color: #000000; line-height: 30px;">
                                                                    I have donated to MATE, helping to develop the creativity and talent of children, you can also donate and promote education and art.</p><br>

                                                                <p style="text-align: center;"><a style="background: #000; color: #FFF; padding-top: 10px; padding-bottom: 10px; padding-left: 20px; padding-right: 20px;" href="https://www.mate.pe/demo-donacion" target="_blank">DONATE</a></p><br>
                                                                <p style="text-align: center; color: #000;">Learn more about MATE <a style="color: #000;" href="https://www.mate.pe" target="_blank">here</a>.</p>
                                                                <br>
                                                                <p style="text-align: left; color: #000000;">Regards<br><br>{{$name}}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
