                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent" style="padding-top: 30px; padding-bottom: 0;">
                                                                <table width="100%" style="text-align: right;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 100%;">
                                                                            <p style="text-align: right; color: #000;">Follow us</p>
                                                                        </td>
                                                                        <td>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="middle" class="textContent">
                                                                <h1 style="text-align: center; font-size: 55px; font-weight: bold; color: #000000;">THANKS</h1>

                                                                <p style="text-align: center; font-size: 16px; color: #000000; line-height: 30px;">Thanks to your donation, MATE — a not-for-profit organization, will continue celebrating and promoting culture in our country, today and for future generations.</p>
                                                                ...
                                                                @if($donation->recurrent == "si")
                                                                    <br>
                                                                    <br>
                                                                    <p style="text-align: center; font-size: 12px; color: #000000;">You have subscribed to a recurring @php if($donation["recurrent_mode"] === "anual") { echo "<b>yearly</b>"; } else{ echo "<b>monthly</b>"; } @endphp of ${{$donation->amount}}.<br>If you wish to cancel this subscription, click <a href="https://www.mate.pe/demo-donacion/cancel-suscription/{{$donation->subscription_stripe_id}}" style="color: #1b1b1b;" target="_blank">here</a>.</p>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    </table>
